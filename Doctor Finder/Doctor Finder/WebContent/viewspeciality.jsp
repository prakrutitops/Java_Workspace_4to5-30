               ...
               <div class="col-xs-12 col-sm-12 col-md-12 pull-left doctors-3col-tabs no-pad">
              	...
              	<!-- Nav tabs -->
                      ...
                      String speciality =  request.getParameter("speciality");
                      	...
                      	ArrayList<Doctorsbean> records = s.allspeciality(speciality);
                      ...
                      <div>
                        ...
                        <div class="doctor-box col-md-4 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-delay="0.5s" data-wow-offset="200">
                      	...
                      	<div class="doc-name">
                          	...
                          	<span class="doc-title"><%=d.getSpeciality() %></span><br>
                          	...
                          	<hr />
                          	<p><button type="submit" class="btn btn-primary" >Appointment</button></p>
                          </div>
                         </div>
                          <%} %>
