...
%>			
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="admin_feedback.jsp"><svg class="glyph stroked email"><use xlink:href="#stroked-email"/></svg>All Feedbacks</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><svg class="glyph stroked email"><use xlink:href="#stroked-email"/></svg></a></li>
						...
						<div class="col-md-4">
							<div class="panel panel-primary">
								<div class="panel-heading">
									Doctor: <%=fdb1.getFdrname() %>
								</div>
								<div class="panel-body">
									<p>
										<label>Speciality : <%=fdb1.getFdrspeciality() %></label>
										<br>
										<label>Username : <%=fdb1.getFuser() %></label>
										<br>
										<label>Message: <%=fdb1.getFmsg() %></label>
									
										<div class="form-group">
											<div class="col-md-12 widget-right">
<!-- 												<button style="float: left;" type="submit" class="btn btn-primary">Edit Profile</button>&nbsp; -->
												<a href="../delfeedback?id=<%=fdb1.getFid()%>">
