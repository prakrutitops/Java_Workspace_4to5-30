...
%>			
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">		
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Add New Doctor</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="../AdminDr" method="post" enctype="multipart/form-data">
							<fieldset>
								<!-- Name input-->
								<div class="form-group">
									<label class="col-md-3 control-label">Doctor's Name</label>
									<div class="col-md-9">
									<input id="name" name="drname" type="text" placeholder="Name" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="email" name="dremail" type="text" placeholder="Email" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="drsp" name="drspeciality" type="text" placeholder="Speciality" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="drpno" name="drphno" type="text" placeholder="Phone No." class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="drltn" name="drloc" type="text" placeholder="Location" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" id="addr" name="draddr" placeholder="Address" rows="5"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										<button style="float: right;" type="submit" class="btn btn-primary">Submit Doctor's Information</button>
									</div>
								</div>
							</fieldset>
						</form>
