				...
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted">All Doctors</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="../Drimg" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										<button style="float: right;" type="submit" class="btn btn-primary">Update Doctor's Image</button>
									</div>
								</div>
							</fieldset>
						</form>
