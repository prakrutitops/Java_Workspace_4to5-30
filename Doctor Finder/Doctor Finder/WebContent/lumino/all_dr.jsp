...
%>			
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="all_dr.jsp"><svg class="glyph stroked eye"><use xlink:href="#stroked-eye"/></svg>All Doctors</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><svg class="glyph stroked eye"><use xlink:href="#stroked-eye"/></svg></a></li>
			...
			<div class="col-lg-12">
				<h1 class="page-header">All Doctors</h1>
					  ...
					  <%
                      	...
                      	{
                      		/* System.out.println("Doctor Name : "+d.getName()+" Image : "+d.getImage()); */
                      %>
						...
						<div class="col-md-4">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<p>
										<label><a href="editdrpic.jsp?id=<%=d.getId() %>"><img src="../<%=d.getImage() %>" width="300px;" height="200px;"></a></label>
										<br>
										<label>Speciality : <%=d.getSpeciality() %></label>
										<br>
										<label>Email : <%=d.getEmail() %></label>
										<br>
										<label>Ph no : <%=d.getContact_no() %></label>
										<br>
										<label>Location : <%=d.getLocation() %></label>
										<br>
										<label>Address : <%=d.getAddress() %></label>
										<div class="form-group">
											<div class="col-md-12 widget-right">
												<a href="editdoctor.jsp?id=<%=d.getId()%>">
													<button style="float: left;" type="submit" class="btn btn-primary">Edit Profile</button>&nbsp;
												</a>
												<a href="../editdoctor?id=<%=d.getId()%>">	
