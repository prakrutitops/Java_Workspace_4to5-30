<!DOCTYPE html>
<%@page import="com.bin.Appoinmentbean"%>
<%@page import="com.model.AppoinmentModel"%>
...
%>			
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="admin_appointment.jsp"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"/></svg>All Appointments</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="#"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"/></svg></a></li>
		...
		<div class="row">
			...
			<%
				AppoinmentModel am = new AppoinmentModel();
				ArrayList<Appoinmentbean> records = am.showappointment();
				System.out.println("Number of records :-"+records.size());
				for(Appoinmentbean app2 : records)
				{
			%>	
						...
						<div class="col-md-4">
							<div class="panel panel-primary">
								<div class="panel-heading">
									Doctor: <%=app2.getDrName()%>
								</div>
								<div class="panel-body">
									<p>
										<label>Speciality : <%=app2.getDrSpeciality()%></label>
										<br>
										<label>Username : </label>
										<br>
										<label>Appointment Date : <%=app2.getAppoinmentDate()%></label>
										<br>
										<label>Appointment Time : <%=app2.getAppoinmentTime()%></label>
									
										<div class="form-group">
											<div class="col-md-12 widget-right">
<!-- 												<button style="float: left;" type="submit" class="btn btn-primary">Edit Profile</button>&nbsp; -->
												<a href="../deleteappointment?id=<%=app2.getId()%>">
													<button style="float: right;" type="submit" class="btn btn-primary">Delete Review</button>
												</a>
											</div>
										</div>
									</p>
