                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown"><a href="Area.jsp" ><i class="icon-cog"></i>Area Vise<b class="icon-angle-down"></b></a>
                             ...
                             <li><a href="bookappoinment.jsp" ><i class="icon-cog"></i>Appoinment</a>
    ...
    <section class="complete-content content-footer-space">
      ...
      <!--Title / Beadcrumb-->
           ...
           <div class="container">
          	...
          	<div class="col-md-12 col-xs-12 col-sm-12 pull-left subtitle ibg-transparent">Your search result..</div>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 pull-left doctors-3col-tabs no-pad">
              	...
              	<!-- Nav tabs -->
                      ...
                      <!-- Tab panes -->
 <%
 		ArrayList<Doctorsbean> s = (ArrayList<Doctorsbean>)request.getAttribute("raj");
                    		System.out.println("Records Got :- "+s.size());                 		
 %>                     
	...
	%>
                      	...
                      	<div class="doc-name">
                          	<div class="doc-name-class"><%=d.getName() %></div>
                          	<span><%=d.getSpeciality() %></span><br>
                          	<span class="doc-title">Cantact number :<%=d.getContact_no() %></span><br>
                          	<span class="doc-title">Address :<%=d.getAddress() %></span><br>
                          	<span class="doc-title">Clinic Location :<%=d.getLocation() %></span><br>
                          	<span class="doc-title">E-mail Address :<%=d.getEmail() %></span><br>
                          	<hr />
