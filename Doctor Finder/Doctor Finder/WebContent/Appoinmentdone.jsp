...
<div class="about-intro-wrap pull-left">
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Your Appoinment has been booked..</h1></div>
	 ...
	 <form action="cancelappoinment"  method="post">
		<div class="container" align="center">
			<section class="content bgcolor-6">
				<h2>We will send you confirmation of your appoinment<br>
				 via E-mail within 10 minutes</h2>
				 
				 <span class="input input--juro">
				
					<input type="submit" class="btn btn-1 btn-1a" value="Cancel Appoinment">
