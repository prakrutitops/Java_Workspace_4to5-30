...
<%@page import="com.bin.DrSpecialityFdbean"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.model.DrSpecialityFindDr"%>
<%@page import="com.bin.Registrationbean"%>
<html xmlns="http://www.w3.org/1999/xhtml">
    
<!-- Mirrored from imedica.sharkslab.com/HTML/services-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2016 20:03:15 GMT -->
<head>
...
%>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown active"><a href="Finddoctors.jsp" ><i class="icon-cog"></i>Find Doctors<b class="icon-angle-down"></b></a>
    ...
    <!--About-us top-content-->
         ...
         <%
         	DrSpecialityFindDr m = new DrSpecialityFindDr();
			ArrayList<DrSpecialityFdbean> b = m.showspeciality();
            for(DrSpecialityFdbean s : b)
            {
            %>
            ...
            <div class="col-sm-5 col-xs-12 col-md-3 col-lg-3 service-box no-pad wow fadeInLeft animated" data-wow-delay="1s" data-wow-offset="150">
                <div class="service-title"><div class="service-icon-container rot-y"><i class="icon-medkit panel-icon"></i></div><%=s.getDrSpeciality() %></div>
                <p><%=s.getAboutSpeciality() %></p>
                <a href="viewspeciality.jsp?speciality=<%=s.getDrSpeciality() %>"><button  type="submit" class="btn btn-primary" >View All</button></a>
            </div>
		...
		<div class="call-action-container">
          ...
          <div id="call-action-title">You can see review of Doctors and/or give feedback of your Doctors </div>
            <p>You can find your suitable doctors through see the review and decides how doctors will provides treatment to you.</p>
            <p>You can give feedback of your Doctors and share your opinion like how they treat you,how they easily kill your,those medicinse are recover pain immidiate..   </p>
            
            
            <section class="color-4 purchase-strip-blue ipurchase-text-center">
                    <p class="ipurchase-paragraph">
                    <a href="Rating.jsp">
                        <button class="btn btn-4 btn-4a notViewed purshase-theme-btn">See Review </button>&nbsp;&nbsp;
                        </a>
                        <a href="feedbackform.jsp">
                        <button class="btn btn-4 btn-4a notViewed purshase-theme-btn">Give Feedback</button>
                        </a>
                    </p>
                </section>
 ...
 <div class="cl-wrap icl-wrap">
         ...
         <div class="row">
             ...
             <ul id="testi-client-logos" class="icl-carousel">
                <li><a href="#"><img alt="" src="images/nlogo1.png" class="img-responsive client-logo-img"/></a></li>
                <li><a href="#"><img alt="" src="images/nlogo2.png" class="img-responsive client-logo-img"/></a></li>
                <li><a href="#"><img alt="" src="images/nlogo3.png" class="img-responsive client-logo-img"/></a></li>
                <li><a href="#"><img alt="" src="images/nlogo4.png" class="img-responsive client-logo-img"/></a></li>
                <li><a href="#"><img alt="" src="images/nlogo5.png" class="img-responsive client-logo-img"/></a></li>
                <li><a href="#"><img alt="" src="images/nlogo6.png" class="img-responsive client-logo-img"/></a></li>
            </ul>  
