...
%>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown"><a href="Area.jsp" ><i class="icon-cog"></i>Area Vise<b class="icon-angle-down"></b></a>
                              ...
                              <li class="dropdown"><a href="bookappoinment.jsp">Appoinment<b class="icon-angle-down"></b></a>
                                
                            </li>
                            <li class="active"><a href="Rating.jsp" >Rating</a>
    ...
    <!--Title / Beadcrumb-->
         	<div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
            	<div class="bread-heading"><h1>Give your feedback..</h1></div>
     ...
     <!--map-->
	 <form action="feedback" name="fdb" id="fb" method="post">
...
// 					alert(val);
					...
					//var v=document.feedback.Speciality.value;
					//alert(V);
					}
			}
		}
					...
					<select name="dr" class="input__field input__field--juro" id="input-30" onblur="get_speciality();">
					<option></option>
					<%
				...
				<br>
				<span class="input input--juro">
					<input name="Speciality" class="input__field input__field--juro" type="text" readonly="readonly" id="sp"/>
					<label class="input__label input__label--juro" for="input-29">
					
						<span class="input__label-content input__label-content--juro">Speciality</span>
						
					</label>
				</span>
				<br>
				<span class="input input--juro">
					<input name="msg" class="input__field input__field--juro" type="textarea" rows="50" cols="50" id="input-30" />
					<label class="input__label input__label--juro" for="input-30">
						<span class="input__label-content input__label-content--juro">Message</span>
					</label>
				</span>
				<br>
				<span class="input input--juro">
<!-- 				<a href=""></a> -->
<!-- 					<input type="submit" value="Submit" class="btn btn-1 btn-1a"> -->
					<button class="btn btn-1 btn-1a">Submit</button>
