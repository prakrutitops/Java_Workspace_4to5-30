...
<%--                        %>  --%>
                      ...
                      <div>
                        ...
                        <div>
                        	<!--map2-->
	 <form action="editprofile" name="edituser" id="edit" method="post">
		<div align="center">
		
				<section class="bgcolor-6 content">
						<h2 style="margin-bottom: 100px;">
							<label class="lbl" style="color: white;">EDIT YOUR PROFILE</label>
						</h2>
				...
				<table>
					<tr>
						...
						<td>
							<input style="margin-top:20px;" name="fname" type="text" value="<%=s.getFname()%>" placeholder="First name" class="textox">
							<br><br>
						</td>
					</tr>	
					<tr>	
						...
						<td>
							<input style="margin-top:20px;" name="lname" type="text" value="<%=s.getLname()%>" placeholder="Last name" class="textox">
							<br><br>
						</td>	
					</tr>
					<tr>	
						...
						<td>
							<input style="margin-top:20px;" name="email" type="text" value="<%=s.getEmail()%>" placeholder="Email" class="textox">
							<br><br>
						</td>	
					</tr>
					<tr>	
						...
						<td>
							<input style="margin-top:20px;" name="phno" type="text" value="<%=s.getPh_no()%>" placeholder="Phone No" class="textox">
							<br><br>
						</td>	
					</tr>
					<tr>	
						...
						<td>
							<input style="margin-top:20px;" name="pwd" value="<%=s.getPass()%>" type="text" placeholder="Password" class="textox">
							<br><br>
						</td>	
					</tr>
					<tr>	
						...
						<td>
							<input style="margin-top:20px;" name="cpwd" type="text" value="<%=s.getCpass()%>" placeholder="Confirm Password" class="textox">
							<br><br>
						</td>	
					</tr>
<!-- 					<tr>	 -->
...
<!-- 					</tr> -->
					<tr>	
						...
						<td>
							<input value="<%=s.getDob()%>" style="margin-top:20px;" name="date" type="date" placeholder="Date Of Birth" class="textox">
							<br><br>
						</td>	
					</tr>
				</table>
				<a href="profile.jsp"><button type="submit" class="btn btn-primary">UPDATE</button></a>
				<br><br>
