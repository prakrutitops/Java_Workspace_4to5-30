...
<!-- Mirrored from imedica.sharkslab.com/HTML/blog-masonry-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2016 20:03:34 GMT -->
<head>
...
%>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown active"><a href="Area.jsp" ><i class="icon-cog"></i>Area Vise<b class="icon-angle-down"></b></a>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 pull-left doctors-3col-tabs no-pad">
              	...
              	<!-- Nav tabs -->
                      ...
                      <%
                      		...
                      		ArrayList<Doctorsbean> records = m.area();
                      		for(Doctorsbean s:records)
                      	{
                      %>
                      ...
                      <div>
                        ...
                        <!--Doc intro-->
                        <form action="areavise.jsp" method="post">
                        <div class="doctor-box col-md-4 col-sm-6 col-xs-12 wow fadeInUp animated" data-wow-delay="0.5s" data-wow-offset="200">
                      	...
                      	<div class="doc-name">
                          	<div class="doc-name-class"><%=s.getLocation() %></div>
                          	<span class="doc-title"></span>
                          	<span class="doc-title"></span>
                          	<input type="hidden" name="Location" value="<%=s.getLocation() %>">
                          	<hr />
                          	<button type="submit" class="btn btn-primary" value="<%=s.getLocation() %>" >View all Doctors in <%=s.getLocation() %></button>
                          </div>
                         </div>
                         </form>
                          <%} %>
           ...
           <div > 
            	...
            	<div  class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <%
                        ...
                        {
                    %> 
                   	<img src="images/blog-dummy-3-1.jpg">
                    	
                            <div class="blog-box-title" align="center" ><%=s.getLocation() %></div>
                        
                        <button  type="submit" class="btn btn-primary">view all Doctors in <%=s.getLocation() %></button>
...
<!-- Mirrored from imedica.sharkslab.com/HTML/blog-masonry-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2016 20:03:43 GMT -->
</html>