...
<%@page import="com.bin.Feedbackbean"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.model.Model"%>
<%@page import="com.bin.Registrationbean"%>
<html xmlns="http://www.w3.org/1999/xhtml">

<!-- Mirrored from imedica.sharkslab.com/HTML/page-elements-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2016 20:03:11 GMT -->
<head>
        ...
        <div class="inner-page-title-wrap col-xs-12 col-md-12 col-sm-12">
          ...
          <div class="bread-crumb pull-right">
            <ul>
              ...
              <li><a href="feedbackform.jsp">Give Feedback</a></li>
            </ul>
          </div>
        </div>
      </div>
    			...
    			<div class="row">
			<div class="col-sm-6 col-xs-12 col-md-12 col-lg-12 accordion-element department-wrap wow fadeInDown animated" data-wow-delay="0.5s" data-wow-offset="100" style="visibility: visible;-webkit-animation-delay: 0.5s; -moz-animation-delay: 0.5s; animation-delay: 0.5s;">
			<%
				Model m = new Model();
				ArrayList<Feedbackbean> records  = m.showfeedback();
				for(Feedbackbean fdb1 : records)
				{
			%>

            <div id="accordion" class="ui-accordion ui-widget ui-helper-reset" role="tablist">
                    <h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-accordion-header-active ui-state-active ui-corner-top ui-accordion-icons" role="tab" id="ui-accordion-accordion-header-0" aria-controls="ui-accordion-accordion-panel-0" aria-selected="true" tabindex="0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span><i class="icon-medkit dept-icon"></i><span class="dep-txt"><%=fdb1.getFdrname()%><br>[<%=fdb1.getFdrspeciality()%>]</span></h3>
                    <div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" id="ui-accordion-accordion-panel-0" aria-labelledby="ui-accordion-accordion-header-0" role="tabpanel" aria-expanded="true" aria-hidden="false" style="display: block;">
                        ...
                        <div class="dept-title pull-left"><%=fdb1.getFuser() %></div> 
                        <br>
                        <p>User Review :- <%=fdb1.getFmsg() %></p>
...
$('#circle4').progressCircle({
	nPercent        : 95,
	showPercentText : true,
	circleSize      : 150,
	thickness       : 2,
});
$('#circle5').progressCircle({
	nPercent        : 100,
	showPercentText : true,
	circleSize      : 150,
	thickness       : 2,
...
<!-- Mirrored from imedica.sharkslab.com/HTML/page-elements-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2016 20:03:13 GMT -->
</html>
