...
%>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="Alldoctors.jsp" ><i class="icon-cog"></i>All Doctors<b></b></a>
           ...
           <div class="container">
              ...
              <!--About-us top-content-->
					<%
                        ...
                        String areavise1 = request.getParameter("Location");
                        System.out.println(areavise1);
            			
            			
                      	ArrayList<Doctorsbean> records1 = s.areavicedr(areavise1);
                      	for(Doctorsbean d:records1)
                      	{
                     %>
    
       
          	<div class="col-md-12 col-xs-12 col-sm-12 pull-left subtitle ibg-transparent">All Doctors in <%=d.getLocation() %></div>
               <div class="col-xs-12 col-sm-12 col-md-12 pull-left doctors-3col-tabs no-pad">
                  <div class="content-tabs tabs col-xs-12 col-sm-12">
                        ...
                        <div class="doctor-box col-md-4 col-sm-6 col-xs-12">
                      	...
                      	<div class="doc-name">
                          	<div class="doc-name-class"><%=d.getName() %></div><span class="doc-title"><%=d.getSpeciality() %></span>
                          	<hr />
                          	<p>Address : <%=d.getAddress()%><br>
                          	Contact No.: <%=d.getContact_no()%><br>
                          	Email Address : <%=d.getEmail()%><br>
