...
/**
 * Servlet implementation class UpdateAdminDr
 */
@WebServlet("/UpdateAdminDr")
public class UpdateAdminDr extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateAdminDr() {
        super();
...
//						drb.setId(Integer.parseInt(fitem.getString()));
...
//					
//					System.out.println("On UpdateAdminDrController :- "+drb.getSpeciality());
//				}
//				else
//				{
//					fItem=fitem;
...
//		}
		...
		Doctorsbean drb = new Doctorsbean();
		drb.setId(Integer.parseInt(request.getParameter("id")));
...
//		System.out.println("Id On Update Controller "+drb.getId());
